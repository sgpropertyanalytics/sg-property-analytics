...
AGGREGATE_SUMMARY_PARAM_SCHEMA = ParamSchema(
    fields={
        "district": FieldSpec(
            name="district",
            type=str,
        ...
        "bin_count": FieldSpec(
            ...
            type=int,
            default=10,
            description="Number of histogram bins (max 20)"
        ),
    },
    aliases={
        "saleType": "sale_type",
...
AGGREGATE_SUMMARY_SERVICE_SCHEMA = ServiceBoundarySchema(
    fields={
        "districts": FieldSpec(name="districts", type=list, nullable=True),
        "segments": FieldSpec(name="segments", type=list, nullable=True),
        "bedrooms": FieldSpec(name="bedrooms", type=list, nullable=True),
        ...
        "date_from": FieldSpec(name="date_from", type=date, nullable=True),
        "date_to_exclusive": FieldSpec(name="date_to_exclusive", type=date, nullable=True),
        "price_min": FieldSpec(name="price_min", type=float, nullable=True),
        "price_max": FieldSpec(name="price_max", type=float, nullable=True),
        "psf_min": FieldSpec(name="psf_min", type=float, nullable=True),
        "psf_max": FieldSpec(name="psf_max", type=float, nullable=True),
        "bin_count": FieldSpec(name="bin_count", type=int, default=10),
    }
)

AGGREGATE_SUMMARY_RESPONSE_SCHEMA = ResponseSchema(
    data_fields={},
    meta_fields={
        "requestId": FieldSpec(name="requestId", type=str, required=True),
        "elapsedMs": FieldSpec(name="elapsedMs", type=float, required=True),
...
AGGREGATE_SUMMARY_CONTRACT = EndpointContract(
    endpoint="aggregate-summary",
    version="v3",
    param_schema=AGGREGATE_SUMMARY_PARAM_SCHEMA,
    service_schema=AGGREGATE_SUMMARY_SERVICE_SCHEMA,
    response_schema=AGGREGATE_SUMMARY_RESPONSE_SCHEMA,
)

register_contract(AGGREGATE_SUMMARY_CONTRACT)
