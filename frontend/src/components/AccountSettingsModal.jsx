...
/**
 * AccountSettingsModal - 2-tab modal for user account management
 *
 * Tab 1 - General:
 ...
 * Tab 2 - Billing & Plan:
 * - Current Plan card
 * - Manage Subscription (Stripe Customer Portal) for premium users
          ...
          <div className="p-6">
            ...
            {activeTab === 'billing' && (
              <div className="space-y-6">
                {/* Current Plan */}
                <div>
                  <h3 className="text-sm font-medium text-[#547792] mb-3">Current Plan</h3>
                ...
                {isPremium && (
                  <button
                    ...
                    disabled={loading}
                    className="w-full px-4 py-3 bg-[#213448] text-white rounded-lg font-medium hover:bg-[#547792] disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      'Loading...'
                    ) : (
                ...
                {!isPremium && (
                  <button
                    ...
                    className="w-full px-4 py-3 bg-[#213448] text-white rounded-lg font-medium hover:bg-[#547792] transition-colors flex items-center justify-center gap-2"
                  >
                ...
                {/* Payment info note */}
                <div className="flex items-start gap-2 p-3 bg-[#EAE0CF]/30 rounded-lg">
