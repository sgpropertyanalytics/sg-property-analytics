            ...
            <div className="flex items-center gap-1">
              ...
              {combinedTooltip && (
                <div className="relative group">
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 top-5 z-[100] hidden group-hover:block w-64 max-w-[calc(100vw-2rem)] p-3 bg-[#213448] text-white text-xs leading-relaxed rounded shadow-lg whitespace-pre-line pointer-events-none">
                    {combinedTooltip}
                  </div>
                </div>
              )}
