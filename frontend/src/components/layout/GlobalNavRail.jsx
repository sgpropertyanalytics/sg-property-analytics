 ...
 * 2. Project Analysis - Placeholder
 * 3. Value Parity - Budget search tool
 * 4. Analytics View - Power BI style deep-dive
  ...
  return (
    ...
    >
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ...
                  : 'text-[#94B4C1] hover:bg-[#547792]/30 hover:text-[#EAE0CF]'
                }
              `}
              title={item.label}
            ...
            >
              ...
              <span className="text-[10px] mt-1 font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-center leading-tight max-w-[52px]">
                {item.label.split(' ')[0]}
              </span>

              {/* Tooltip on hover */}
              <div className="absolute left-full ml-3 px-3 py-2 bg-[#213448] text-[#EAE0CF] text-sm font-medium rounded-lg shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-200 whitespace-nowrap z-50 border border-[#547792]/30">
                {item.label}
                <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1 w-2 h-2 bg-[#213448] rotate-45 border-l border-b border-[#547792]/30" />
              </div>
            </button>
          );
        })}
      ...
      <div className="mt-auto pt-4 w-full px-2">
        <button
          className="group relative flex flex-col items-center justify-center w-full aspect-square rounded-xl text-[#94B4C1] hover:bg-[#547792]/30 hover:text-[#EAE0CF] transition-all duration-200"
          title="Settings"
        >
