...
export function PowerBIFilterSidebar({ collapsed = false, onToggle }) {
  ...
  if (collapsed) {
    return (
      <div className="w-12 bg-[#EAE0CF] border-r border-[#94B4C1]/30 flex flex-col items-center h-full">
        {/* Expand button at top */}
        <button
          type="button"
          onClick={onToggle}
          className="w-full py-3 flex items-center justify-center hover:bg-[#94B4C1]/30 transition-colors border-b border-[#94B4C1]/30"
