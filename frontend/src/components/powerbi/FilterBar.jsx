      ...
      <div className="lg:hidden mb-6">
        <div className="p-3 bg-card/60 rounded-none backdrop-blur-sm">
          <button
            ...
            className="w-full min-h-[44px] px-4 flex items-center justify-center gap-2 bg-card/80 rounded-none border border-[#94B4C1]/30 text-[#547792] hover:border-[#547792] active:bg-[#EAE0CF]/50  transition-none"
          >
            ...
            {activeFilterCount > 0 && (
              <span className="bg-[#213448] text-white text-xs font-mono uppercase tracking-wider px-2 py-0.5 rounded-none">
                {activeFilterCount}
              </span>
            )}
          </button>
