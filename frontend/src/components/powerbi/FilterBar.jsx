      ...
      <div className="lg:hidden mb-6">
        <div className="p-3 bg-card/60 rounded-none backdrop-blur-sm">
          <button
            ...
            className="w-full min-h-[44px] px-4 flex items-center justify-center gap-2 bg-card/80 rounded-none border border-mono-muted text-[#547792] hover:border-[#547792] active:bg-black/[0.04] transition-none"
          >
