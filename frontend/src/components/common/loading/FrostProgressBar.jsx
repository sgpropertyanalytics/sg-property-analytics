 ...
 * Uses a gradient from transparent to blue (#547792) to transparent.
 *
      ...
      {visible && (
        ...
        >
          {prefersReducedMotion ? (
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#547792] to-transparent opacity-60" />
          ) : (
            // Animated sliding bar
            <motion.div
              className="absolute h-full w-1/3 bg-gradient-to-r from-transparent via-[#547792] to-transparent"
              animate={{
                x: ['-100%', '400%'],
              }}
              transition={{
