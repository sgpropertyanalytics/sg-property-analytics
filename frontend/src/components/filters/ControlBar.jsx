...
export function ControlBar() {
  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-wrap items-center gap-3 p-4 bg-card/60 rounded-lg border border-[#94B4C1]/20 backdrop-blur-sm">
        <RegionDropdown />
        <DistrictCombobox />
      ...
      <div className="md:hidden p-3 bg-card/60 rounded-lg backdrop-blur-sm">
        <button
