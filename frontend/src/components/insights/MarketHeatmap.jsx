...
export default function MarketHeatmap() {
  ...
  const { data: districtData = [], status, error, refetch } = useAppQuery(
    ...
    { chartName: 'MarketHeatmap', initialData: null }
  );
                    ...
                    {hoveredDistrictData.has_data ? (
                      <div className="space-y-1.5">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-semibold text-[#213448] font-mono tabular-nums">
                            {formatPsf(hoveredDistrictData.median_psf)}
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-[#547792]">Observations</span>
                          <span className="font-medium text-[#213448] font-mono tabular-nums">
        ...
        <div className="px-4 py-3 md:px-6 md:py-4 bg-[#EAE0CF]/10 border-t border-[#94B4C1]/20">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-sm md:text-base font-semibold text-[#213448] font-mono tabular-nums">
